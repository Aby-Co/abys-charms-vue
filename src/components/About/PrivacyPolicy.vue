...
<template>
  <div class="about px-10 py-10 text-left space-y-4">
    ...
    <ul>
      ...
      <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
          &quot;Our&quot; in this Agreement) refers to ABY AND CO, 343A ward 12, Mottavila, Pulluvila PO 695526.</p>
      </li>
      <li>
      ...
      <li>
        <p><strong>Website</strong> refers to Aby's Charms, accessible from <a href="https://www.abyscharms.com/"
            rel="external nofollow noopener" target="_blank">https://www.abyscharms.com/</a></p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: sylvester@abyscharms.com</li>
    </ul>
  </div>
</template>
